...
<h1 className='text-white text-[3rem] my-7 text-center shadow-[0 0 30px rgba()]' >Why People Prefer Us</h1>
    
    <div className='flex flex-col justify-center items-center gap-7 my-7   lg:flex lg:flex-row' >
        
        <div className='w-full md:w-full lg:w-[28vw] bg-gray-800 text-white p-5 rounded-2xl flex flex-col items-start flex-wrap shadow-[0_0_30px_rgba(14,116,144,0.8)] rotation'>
...
<ul className='list-disc list-inside'>
    ...
    <li className='text-[1rem] text-white p-1'>Adherence to best industry practices.</li>
         ...
         <div className='w-full md:w-full lg:w-[28vw] bg-gray-800 text-white p-5 rounded-2xl flex flex-col items-start flex-wrap shadow-[0_0_40px_rgba(14,116,144,0.8)] rotation'>
